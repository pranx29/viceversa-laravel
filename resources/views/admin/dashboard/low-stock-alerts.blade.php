<div class="shadow-md rounded-lg">
    <h2 class="text-2xl font-bold text-primary-foreground mb-2">Low Stock Alerts</h2>
    <div
        ...
        <table class="w-full text-left table-auto min-w-max">
            <thead>
                <tr class="border-b border-foreground bg-primary">
                    ...
                    <th class="p-4 text-sm font-normal leading-none text-foreground">Remaining Stock</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($lowStockProducts as $product)
                    <tr class="cursor-pointer hover:bg-primary">
                        ...
                        <td class="p-4 border-b border-foreground text-primary-foreground py-3">{{ $product['quantity_in_stock'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
